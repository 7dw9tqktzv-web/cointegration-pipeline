...
## 11. Bilan V2.1 — transition vers V2.2

Suite aux invalidations (sigma_eq compresse, sigma_rolling aberrant,
GC/PA non-tradeable, decorrelation Z/PnL), une refonte du signal engine
est necessaire. L'architecture bi-couche et les resultats sont documentes
dans `outputs/v2/backtest_diagnostic_v2.2.md`.
